...
from snowfall.models import AcousticModel, transformer,conformer,tdnn,tdnn_lstm

# from ovad.dataset import K2VadDataset
from ovad.models import TdnnLstm1a, TdnnLstm1b
...
def main():
    ...
    # load dataset
    feature_dir = Path("data/fbank")
    logging.info("About to get train cuts")
    cuts_train = CutSet.from_jsonl(feature_dir / "universal_vad_train.jsonl.gz")
    logging.info("About to get dev cuts")
    cuts_dev = CutSet.from_jsonl(feature_dir / "universal_vad_dev.jsonl.gz")
